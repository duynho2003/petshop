...
<body>
            ...
            <div class="col-md-8">
                <div class="product-details mr-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                        ...
                        <input type="number" value="{{ $details['quantity'] }}" placeholder="" required class="input-quantity" data-pid="{{ $details['id'] }}" min="0" />


                        <!-- <div class="d-flex flex-row align-items-center"><input type="number" value="{{ $details['quantity'] }}" class="d-block"/>
                        </div> -->
                        <span class="d-block ml-5 font-weight-bold">{{ $details['promotion_price'] }} USD</span>
    ...
    <script type="text/javascript">
        ...
        $(".continue__btn.update__btn a").click(function(e) {
            ...
            $('input.input-quantity').each(function(index, value) {
                pids.push($(value).data('pid'));
                qties.push($(value).val());
            });
            $.ajax({
