                                    ...
                                    <div class="breeder-active owl-carousel">
                                        <div class="breeder-item">
                                            <a href="breeder-details.html">
                                                <img src="{{ asset ('fe/img/images/breeder_img01.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="breeder-item">
                                            <a href="breeder-details.html">
                                                <img src="{{ asset ('fe/img/images/breeder_img02.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="breeder-item">
                                            <a href="breeder-details.html">
                                                <img src="{{ asset ('fe/img/images/breeder_img03.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="breeder-item">
                                            <a href="breeder-details.html">
                                                <img src="{{ asset ('fe/img/images/breeder_img04.jpg') }}" alt="">
                                            </a>
                                        </div>
                                        <div class="breeder-item">
                                            <a href="breeder-details.html">
                                                <img src="{{ asset ('fe/img/images/breeder_img05.jpg') }}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="breed-services-info" data-background="{{ asset ('/fe/img/bg/breed_services_bg.jpg') }}">
